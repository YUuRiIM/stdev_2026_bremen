...
const PIECE_CFG: Record<string, any> = {
...
function computePivots(manifest: any) {
  ...
  const piecePivot = (x0: number, y0: number, x1: number, y1: number) => ({
    x: tLeft + tW * ((x0 + x1) / 2),
    y: tTop + tH * ((y0 + y1) / 2),
  });
  return {
...
function pctOrigin(pivot: { x: number; y: number }, manifest: any) {
  return `${(pivot.x / manifest.width) * 100}% ${(pivot.y / manifest.height) * 100}%`;
}

function layerStyle(layer: any, manifest: any): React.CSSProperties {
  const { bbox } = layer;
...
function useChestSprings(bodyY: any) {
  const bodyV = useVelocity(bodyY);

  const impulses: Record<string, any> = {
  ...
  const yImpulses: Record<string, any> = {
    chest_l_r1_out: useMotionValue(0),
    chest_l_r1_in: useMotionValue(0),
    chest_l_r2_out: useMotionValue(0),
    chest_l_r2_in: useMotionValue(0),
  ...
  const ySprings: Record<string, any> = {
  ...
  const scales: Record<string, any> = {
    chest_l_r1_out: {
      scaleY: useTransform([springs.chest_l_r1_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r1_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r1_out,
    },
    chest_l_r1_in: {
      scaleY: useTransform([springs.chest_l_r1_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r1_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r1_in,
    },
    chest_l_r2_out: {
      scaleY: useTransform([springs.chest_l_r2_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r2_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r2_out,
    },
    chest_l_r2_in: {
      scaleY: useTransform([springs.chest_l_r2_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r2_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r2_in,
    },
    chest_l_r3_out: {
      scaleY: useTransform([springs.chest_l_r3_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r3_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r3_out,
    },
    chest_l_r3_in: {
      scaleY: useTransform([springs.chest_l_r3_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r3_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r3_in,
    },
    chest_l_r4_out: {
      scaleY: useTransform([springs.chest_l_r4_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r4_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r4_out,
    },
    chest_l_r4_in: {
      scaleY: useTransform([springs.chest_l_r4_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_l_r4_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_l_r4_in,
    },
    chest_r_r1_in: {
      scaleY: useTransform([springs.chest_r_r1_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r1_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r1_in,
    },
    chest_r_r1_out: {
      scaleY: useTransform([springs.chest_r_r1_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r1_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r1_out,
    },
    chest_r_r2_in: {
      scaleY: useTransform([springs.chest_r_r2_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r2_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r2_in,
    },
    chest_r_r2_out: {
      scaleY: useTransform([springs.chest_r_r2_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r2_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r2_out,
    },
    chest_r_r3_in: {
      scaleY: useTransform([springs.chest_r_r3_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r3_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r3_in,
    },
    chest_r_r3_out: {
      scaleY: useTransform([springs.chest_r_r3_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r3_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r3_out,
    },
    chest_r_r4_in: {
      scaleY: useTransform([springs.chest_r_r4_in, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r4_in, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
      y: ySprings.chest_r_r4_in,
    },
    chest_r_r4_out: {
      scaleY: useTransform([springs.chest_r_r4_out, breath], ([p, b]: number[]) => 1 + p + b),
      scaleX: useTransform([springs.chest_r_r4_out, breath], ([p, b]: number[]) => 1 - p * 0.35 + b * 0.3),
...
function IrisLayer({ layer, manifest, assetBase, x, y }: any) {
  return (
    <motion.img
...
export function Character({
  ...
  const { outsideHead, headLayers, headStartZ } = useMemo(() => {
    const sorted = [...manifest.layers].sort((a: any, b: any) => a.z - b.z);
    const bodyOrArmZs = sorted
      .filter((l: any) => BODY_ROLES.has(l.role) || ARM_ROLES.has(l.role) || CHEST_ROLES.has(l.role))
      .map((l: any) => l.z);
    ...
    const startZ = inside.length ? Math.min(...inside.map((l: any) => l.z)) : maxBodyZ + 1;
  ...
  const wrapperFill: React.CSSProperties = { position: 'absolute', inset: 0, pointerEvents: 'none', willChange: 'transform' };
  ...
  const renderPlain = (layer: any, prefix = 'layer') => (
  ...
  const renderOutside = (layer: any) => {
    if (ARM_ROLES.has(layer.role)) {
      return (
        ...
        >
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={`${assetBase}/${layer.src}`} draggable={false} style={layerStyle(layer, manifest)} alt="캐릭터 팔 레이어" />
        </motion.div>
      );
    }
    if (chestScales[layer.role]) {
      ...
      return (
        ...
        >
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={`${assetBase}/${layer.src}`} draggable={false} style={layerStyle(layer, manifest)} alt="캐릭터 몸통 레이어" />
        </motion.div>
      );
    }
  ...
  const renderEyeGroup = (group: any) => (
    <motion.div
      key={`eye-${group.z}`}
    ...
    >
      <motion.div style={{ ...wrapperFill, transformOrigin: bodyOrigin, y: bodyY }}>
        ...
        <motion.div
          ...
          animate={headCtl}
        >
          {insideNodes.map((n: any) => (n.kind === 'eye' ? renderEyeGroup(n) : renderPlain(n.layer, 'head')))}
        </motion.div>
      </motion.div>
    </motion.div>
  );
