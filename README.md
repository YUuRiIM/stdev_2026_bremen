...
> **For devs:** Next.js 15 + LiveKit voice agent + LLM judge 가 하나의 pnpm 모노레포에서 동작하는 참조 구현입니다.

**AI 학생을 가르치는 비주얼 노벨 학습 게임. 학습자가 교수가 된다.**

_풀지 마세요. 가르치세요._

[Quick Start](#quick-start) • [Gameplay](#gameplay-loop) • [Architecture](#architecture) • [AI Judge](#ai-judge-pipeline) • [Commands](#commands) • [Docs](#docs) • [Team](#team--bremen)
...
> `node_modules` 는 루트에서 hoisted 관리. 각 패키지 의존성은 자동 링크.
...
| **04** | Judge | LLM 이 정확성·명료성·깊이 3축 × 0–5점 채점 |
...
평가는 실제로 동작합니다. INPUT 부터 STATE 까지 5-stage 파이프라인.
...
<p align="center">
  ...
  <sub>함께 공부하고, 함께 설레는 경험을 만들겠습니다.</sub>
</p>
